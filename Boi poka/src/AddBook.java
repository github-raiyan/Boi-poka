...
public class AddBook extends JFrame {
	...
	public void design() {
		...
		JLabel newBook_lable = new JLabel("New Book");
		newBook_lable.setHorizontalAlignment(SwingConstants.CENTER);
		newBook_lable.setForeground(new Color(255, 255, 255));
		newBook_lable.setFont(new Font("Segoe UI", Font.BOLD, 14));
		newBook_lable.setBounds(1, 30, 599, 30);
		contentPane.add(newBook_lable);
		...
		bookName_lable.setBounds(101, 80, 100, 30);
		...
		bookName_tf.setBounds(201, 80, 300, 30);
		...
		bookWriterName_label.setBounds(101, 130, 100, 30);
		...
		bookWriterName_tf.setBounds(201, 130, 300, 30);
		...
		bookType_label.setBounds(101, 180, 100, 30);
		...
		bookType_tf.setBounds(201, 180, 300, 30);
		...
		bookEditionNo_label.setBounds(101, 230, 100, 30);
		...
		bookEditionNo_tf.setBounds(201, 230, 100, 30);
		...
		bookPrice_label.setBounds(301, 230, 100, 30);
		...
		bookPrice_tf.setBounds(401, 230, 100, 30);
		...
		bookPublication_label.setBounds(101, 280, 100, 30);
		...
		bookPublication_tf.setBounds(201, 280, 100, 30);
		...
		bookCoverImage_label.setBounds(301, 280, 100, 30);
		...
		bookImage_tf.setBounds(401, 280, 100, 30);
		...
		bookDetails_label.setBounds(101, 330, 100, 30);
		...
		bookDetails_tf.setBounds(201, 330, 300, 30);
		...
		addBook_btn.setBounds(361, 370, 140, 30);
